...
<div class="wp-block-group alignfull welcome"
    style="margin-top:0px;padding-top:70px;padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
    ...
    <h2 class="wp-block-heading has-text-align-center has-max-72-font-size"
        style="margin-bottom:0px;letter-spacing:-1px">
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-center is-style-columns-reverse">
        ...
        <div class="wp-block-column is-vertically-aligned-center">
            ...
            <div class="wp-block-group">
                ...
                <h2 class="wp-block-heading has-max-36-font-size" id="text-on-left-image-on-right">
                    <?php echo esc_html__('Build with Frost', 'frost'); ?>
                </h2>
                <!-- /wp:heading -->
                <!-- wp:paragraph -->
                <p>
                    <?php echo esc_html__('Frost is a powerful WordPress theme created for agencies and professional website builders. With its clean, minimal design, Frost provides the perfect canvas for stylish and sophisticated websites.', 'frost'); ?>
                </p>
                <!-- /wp:paragraph -->
                <!-- wp:buttons -->
                <div class="wp-block-buttons"><!-- wp:button {"textColor":"base"} -->
                    <div class="wp-block-button"><a
                            class="wp-block-button__link has-base-color has-text-color wp-element-button">
                            <?php echo esc_html__('Get Started', 'frost'); ?> →
                        </a></div>
                    <!-- /wp:button -->
                </div>
        ...
        <!-- wp:column {"verticalAlignment":"center","width":""} -->
        <div class="wp-block-column is-vertically-aligned-center">
            <!-- wp:image {"id":5796,"sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full"><img
                    src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/sample_white_1200x1200.jpg'; ?>"
                    alt="<?php echo esc_attr__('Sample Image', 'frost'); ?>" class="wp-image-5796" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
...
<div class="wp-block-group alignfull" id="features"
    style="margin-top:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
    ...
    <div class="wp-block-columns are-vertically-aligned-center" style="margin-bottom:var(--wp--preset--spacing--large)">
        ...
        <div class="wp-block-column is-vertically-aligned-center">
            <!-- wp:image {"id":5489,"sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full"><img
                    src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/sample_1200x1200.jpg'; ?>"
                    alt="<?php echo esc_attr__('Sample Image', 'frost'); ?>" class="wp-image-5489" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
        <!-- wp:column {"verticalAlignment":"center"} -->
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
            <h2 class="wp-block-heading has-x-large-font-size">
                <?php echo esc_html__('Fresh patterns. Endless Layouts.', 'frost'); ?>
            </h2>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            <p>
                <?php echo esc_html__('Frost is a masterpiece of design and functionality. It features a range of valuable elements, including hero and portfolio sections, prominent call-to-action buttons, and customer testimonials.', 'frost'); ?>
            </p>
            <!-- /wp:paragraph -->
            <!-- wp:buttons -->
            <div class="wp-block-buttons">
                ...
                <div class="wp-block-button"><a
                        ...
                        style="padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--medium)">
                        <?php echo esc_html__('Get Started', 'frost'); ?> →
                    </a></div>
                <!-- /wp:button -->
            </div>
    ...
    <div class="wp-block-columns is-style-columns-reverse" style="margin-bottom:var(--wp--preset--spacing--large)">
        ...
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
            <h2 class="wp-block-heading has-x-large-font-size">
                <?php echo esc_html__('One theme. Infinite designs.', 'frost'); ?>
            </h2>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            <p>
                <?php echo esc_html__('Frost utilizes the potential of the editor to create link pages, serve as a powerful tool for building relationships with clients, sharing valuable content, and boosting social media engagement.', 'frost'); ?>
            </p>
            <!-- /wp:paragraph -->
            <!-- wp:buttons -->
            <div class="wp-block-buttons">
        ...
        <div class="wp-block-column"><!-- wp:image {"id":5490,"sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full"><img
                    src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/sample_1200x1200.jpg'; ?>"
                    alt="<?php echo esc_attr__('Sample Image', 'frost'); ?>" class="wp-image-5490" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
    ...
    <div class="wp-block-columns" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
        ...
        <div class="wp-block-column"><!-- wp:image {"id":5492,"sizeSlug":"full","linkDestination":"none"} -->
            <figure class="wp-block-image size-full"><img
                    src="<?php echo esc_url(get_theme_file_uri()) . '/assets/images/sample_1200x1200.jpg'; ?>"
                    alt="<?php echo esc_attr__('Sample Image', 'frost'); ?>" class="wp-image-5492" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
        <!-- wp:column {"verticalAlignment":"center"} -->
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"fontSize":"x-large"} -->
            <h2 class="wp-block-heading has-x-large-font-size">
                <?php echo esc_html__('Stylish websites. Simply made.', 'frost'); ?>
            </h2>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
            <p>
                <?php echo esc_html__('Whether you’re building a website for your business, personal brand, or creative project, Frost is the perfect solution for anyone looking to launch a website quickly and efficiently.', 'frost'); ?>
            </p>
            <!-- /wp:paragraph -->
            <!-- wp:buttons -->
            <div class="wp-block-buttons">
